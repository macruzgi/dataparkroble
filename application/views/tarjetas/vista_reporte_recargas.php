                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
							...
							<form id="frmRegistro" action="<?php echo base_url();?>Tarjetas/VistaReporteRecarga" method="POST">
							<div class="row clearfix">
								<div class="col-xs-6">
							 ...
							 <div class="table-responsive"> 
                                <table class="table table-bordered table-striped table-hover dataTable" id="tblListado">
                                    ...
                                    <tbody>
										<?php
										if(isset($TraerRecargasPorFecha)){
											foreach($TraerRecargasPorFecha as $filasEcnotradas):
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php echo $filasEcnotradas->NO_FACTURA_TRANSACCION;?></td>
												<td><?php echo date("d-m-Y H:i:s", strtotime($filasEcnotradas->PaymentDate));?></td>
												<td><?php echo $filasEcnotradas->USUARIO;?></td>
                                            </tr>
                                            <?php
												endforeach;
										}
